            ...
            <div className="container app-footer__inner">
                ...
                <div className="app-footer__columns">
                    <div className="app-footer__column">
                        <h4>Product</h4>
                        {brand.navigation.footer.product.map(link => (
                    ...
                    <div className="app-footer__column">
                        <h4>Company</h4>
                        {brand.navigation.footer.company.map(link => (
                            <Link key={link.href} to={link.href}>{link.label}</Link>
                        ))}
                    </div>
                    ...
                    <div className="app-footer__column">
                        <h4>Resources</h4>
                        {brand.navigation.footer.resources.map(link => (
                            <Link key={link.href} to={link.href}>{link.label}</Link>
                        ))}
                    </div>
                    ...
                    <div className="app-footer__column">
                        <h4>Legal</h4>
                        {brand.navigation.footer.legal.map(link => (
                            <Link key={link.href} to={link.href}>{link.label}</Link>
                        ))}
                    </div>
                    ...
                    <div className="app-footer__column">
                        <h4>Support</h4>
                        {brand.navigation.footer.support.map(link => (
                            <Link key={link.href} to={link.href}>{link.label}</Link>
                        ))}
                    </div>
                </div>
