                ...
                <div className="app-footer__main">
                    ...
                    <nav className="app-footer__links">
                        <div className="app-footer__link-group">
                            {brand.navigation.footer.product.slice(0, 3).map(link => (
                                <Link key={link.href} to={link.href}>{link.label}</Link>
                            ))}
                        </div>
                        <div className="app-footer__link-group">
                            {brand.navigation.footer.company.slice(0, 3).map(link => (
                                <Link key={link.href} to={link.href}>{link.label}</Link>
                            ))}
                        </div>
                        <div className="app-footer__link-group">
                            {brand.navigation.footer.legal.slice(0, 3).map(link => (
                                <Link key={link.href} to={link.href}>{link.label}</Link>
                            ))}
                        </div>
                    </nav>
