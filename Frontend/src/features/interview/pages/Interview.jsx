...
const NAV_ITEMS = [
    ...
    { id: 'assistant', label: 'AI Assistant', icon: (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" /></svg>) },
]
        ...
        <div className='interview-page'>
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    <Link
                        to={`/practice?report=${interviewId}`}
                    ...
                    <button
                        ...
                        className='button secondary-button' style={{ marginTop: "0.75rem" }}>
                    ...
                    <button
                        ...
                        className='button secondary-button' style={{ marginTop: "0.75rem" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: "0.6rem" }}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg>
                        Download Report PDF
                    </button>
                </nav>
